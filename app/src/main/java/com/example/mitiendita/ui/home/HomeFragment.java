...
import com.example.mitiendita.Fragments.CategoryListFragment;
import com.example.mitiendita.Fragments.FavoritesListFragment;
import com.example.mitiendita.Fragments.PromotionListFragment;
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.icon_food:
                        setFrament(new PromotionListFragment());
                        return true;
                    case R.id.icon_product:
                        setFrament(new CategoryListFragment());
                        return true;
                    case R.id.icon_favorites:
                        setFrament(new FavoritesListFragment());
                        return true;
                }//switch
                return false;
