...
public class Inicio extends AppCompatActivity {
    ...
    //Obtencion de clave SHA para Facebook
    private void printKeyHash() {
        try {
            PackageInfo info = getPackageManager().getPackageInfo("com.example.sanchez.eatit",
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnSignUp_main:
                Intent signUp = new Intent(Inicio.this, SignUp01.class);
